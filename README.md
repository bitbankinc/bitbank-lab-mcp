...
[![CI](https://github.com/tjackiet/bitbank-lab-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/tjackiet/bitbank-lab-mcp/actions/workflows/ci.yml)
...
/plugin marketplace add tjackiet/bitbank-lab-mcp
...
```bash
git clone https://github.com/tjackiet/bitbank-lab-mcp.git
cd bitbank-lab-mcp
npm ci
```
...
バグ報告や機能要望は [GitHub Issues](https://github.com/tjackiet/bitbank-lab-mcp/issues) からお願いします。Issue テンプレートを用意していますので、用途に合ったものを選択してください。
